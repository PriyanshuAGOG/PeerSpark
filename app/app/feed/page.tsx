...
import { Heart, MessageCircle, Share2, Bookmark, Search, TrendingUp, Users, Filter } from "lucide-react"
...
export default function FeedPage() {
  ...
  const handleShare = (postId: string) => {
    const post = posts.find((p) => p.id === postId)
    if (post) {
      navigator.clipboard.writeText(`Check out this post by ${post.author.name}: ${post.content.substring(0, 100)}...`)
      toast({
        title: "Link copied!",
